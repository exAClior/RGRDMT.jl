...
function booda_dual()
    ...
    main_dual(h, 3:6, -1 / π, "etfi.csv", "ennn.csv", SCS.Optimizer)
end
...
function booda2(D)
    ...
    main2(h, D, -1 / π, k0+2:2:k0+10, V0, L, R, "etfi$D.csv", "ntfi$D.csv", MosekTools.Optimizer)
end
...
function dooda_dual()
    ...
    main_dual(h, 3:6, 1 / 4 - log(2), "exxx.csv", "nxxx.csv", SCS.Optimizer)
end
...
function dooda2(D)
    ...
    main2(h, D, 1 / 4 - log(2), 8:2:64, V0, L, R, "exxx$D.csv", "nxxx$D.csv", MosekTools.Optimizer)
end
